...
from process import save_transcript
...
if __name__ == "__main__":
    save_video_sentiments("https://www.youtube.com/watch?v=fLeJJPxua3E")
    
    # with open("data\Best_Short_Motivational_Speech_Video_-_24_HOURS_-_1-Minute_Motivation_#2_sentiments.json", "r") as f:
    #     data = json.load(f)
